...
import com.xperience.aem.xpbootstrap.core.component.internal.PageListItemImpl;
...
import com.xperience.aem.xpbootstrap.core.models.molecules.MleList;

@Model(
	    adaptables = SlingHttpServletRequest.class,
	    adapters = {MleList.class, ComponentExporter.class},
...
public class MleListImpl extends AbstractCompImpl implements MleList {

	
	protected static final String RESOURCE_TYPE = "xpbootstrap/components/master/molecules/mleList/v1/mleList";

    /**
     * Standard logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(MleListImpl.class);
     ...
     */
    static final boolean SHOW_DESCRIPTION_DEFAULT = false;

    /**
     * Default flag indicating if the date should be shown.
     */
    static final boolean SHOW_MODIFICATION_DATE_DEFAULT = false;

    /**
     * Default flag indicating if list items should be linked.
     */
    static final boolean LINK_ITEMS_DEFAULT = false;
    
    static final boolean DISPLAY_ITEM_AS_TEASER_DEFAULT = false;
    ...
    static final String PN_NUMBER_OF_CARDS_IN_ROW_DEFAULT = "list-card-2";
    ...
    private String numberOfCardsInRow;
    ...
    protected void initModel() {
        ...
        numberOfCardsInRow = properties.get(PN_NUMBER_OF_CARDS_IN_ROW, currentStyle.get(PN_NUMBER_OF_CARDS_IN_ROW, PN_NUMBER_OF_CARDS_IN_ROW_DEFAULT));
    }
    ...
    public Collection<ListItem> getListItems() {
        if (this.listItems == null) {
            this.listItems = this.getItems().stream()
    ...
    @Override
    public String getNumberOfCardsInRow() {
    ...
    private static class ListSort implements Comparator<Page>, Serializable {
        ...
        ListSort(@Nullable final OrderBy orderBy, @Nullable final SortOrder sortOrder, @NotNull Locale locale) {
            ...
            if (orderBy == OrderBy.MODIFIED) {
                ...
                this.pageComparator = (a, b) -> titleComparator.compare(getTitle(a), getTitle(b));
            } else {
