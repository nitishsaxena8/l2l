...
import com.xperience.aem.xpbootstrap.core.component.Utils.LocalizationUtils;
...
/**
 * An internal model that implements the logic used by the {@link XFImpl} in a way it can be used with a
 * {@link SlingHttpServletRequest} or a {@link Resource}.
 */
@Model(adaptables = {Resource.class, SlingHttpServletRequest.class})
public class XFDataImpl {
    ...
    public XFDataImpl(SlingHttpServletRequest request) {
        this(request.getResource());
    }

    public XFDataImpl(Resource resource) {
     ...
     * @see XF#getLocalizedFragmentVariationPath()
     */
    @Nullable
    public String getLocalizedFragmentVariationPath() {
        ...
        String fragmentVariationPath = resource.getValueMap().get(XF.PN_FRAGMENT_VARIATION_PATH, String.class);
