...
import com.xperience.aem.xpbootstrap.core.service.utility.DynamicMediaService;
import com.xperience.aem.xpbootstrap.core.service.utility.configs.DynamicMediaServiceConfig;

@Designate(ocd = DynamicMediaServiceConfig.class)
@Component(service = DynamicMediaService.class, immediate = true)
@ServiceDescription("XP Bootstrap - Dynamic Media Service")
