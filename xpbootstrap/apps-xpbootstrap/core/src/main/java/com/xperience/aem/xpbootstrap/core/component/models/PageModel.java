 ...
 */
@ConsumerType
public interface PageModel extends ContainerExporter, Component {
    ...
    /**
     * Returns the language of this page, if one has been defined. Otherwise the default {@link Locale} will be used.
     *
    ...
    @Nullable
    @JsonIgnore
    default String getCanonicalLink() {
        return null;
    }
    ...
    @NotNull
    @JsonIgnore
    default String getHeaderXfPath() {
    	 return null;
    }
    
    @NotNull
    @JsonIgnore
    default String getFooterXfPath() {
    	 return null;
    }
