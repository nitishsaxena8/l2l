...
import com.xperience.aem.xpbootstrap.core.models.molecules.MleStockedCard;

@Model(
	    adaptables = SlingHttpServletRequest.class,
	    adapters = {MleStockedCard.class, ComponentExporter.class},
	    resourceType= MleStockedCardImpl.RESOURCE_TYPE,
...
public class MleStockedCardImpl extends MleCardImpl implements MleStockedCard {
	
	public static final String RESOURCE_TYPE = "xpbootstrap/components/master/molecules/mleStockedCard/v1/mleStockedCard";
	...
	@PostConstruct
     public void initModel() {
        LOG.info(" --- MleStockedCardImpl initialized ---");
    }
