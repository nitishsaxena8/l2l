package com.deloitte.aem.lead2loyality.core.service.utility.impl;
...
import com.deloitte.aem.lead2loyality.core.service.utility.RestClient;
import com.deloitte.aem.lead2loyality.core.service.utility.configs.RestClientConfigurations;
import com.deloitte.aem.lead2loyality.core.util.RestServiceConstants;
import com.deloitte.aem.lead2loyality.core.util.RestServiceUtils;
...
public class RestClientImpl implements RestClient {
    ...
    public final APIResponse sendRequest(final BaseRequest request, final Map<String, String> headerMap) throws IOException, MethodNotSupportedException {
        ...
        long lStartTime = RestServiceUtils.getStartTime();
        ...
        try {
            ...
            LOG.debug(TOTAL_TIME_TAKEN_FOR_API_REQUEST_MS, RestServiceUtils.logMethodTime(lStartTime));
